...
int main()
{
  unsigned long long int ieos[] = {1, 1, 1, 1, 2, 3, 6, 11, 23, 47, 106, 235, 551,
  ...
  vector<unsigned long long int> series(ieos, ieos + (sizeof(ieos) / sizeof(unsigned long long int)));
  ifstream f("text.txt");
  for (int n; f >> n;)
  {
